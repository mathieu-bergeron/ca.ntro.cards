package ca.ntro.cards.freesort.frontend.views.data;

import ca.ntro.cards.frontend.views.data.CardsViewData;
import ca.ntro.cards.models.values.Card;
import ca.ntro.cards.models.world2d.CommonWorld2d;
import ca.ntro.cards.freesort.models.world2d.Card2d;
import ca.ntro.cards.freesort.models.world2d.World2d;

public class FreesortCardsViewData extends CardsViewData {
