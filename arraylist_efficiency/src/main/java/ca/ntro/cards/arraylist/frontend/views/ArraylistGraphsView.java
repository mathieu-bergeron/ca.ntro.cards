...
import ca.ntro.cards.arraylist.frontend.views.controls.ArraylistEfficiencyMainCanvas;
...
public class ArraylistGraphsView extends EfficiencyGraphsView {

	@FXML
	private VBox cardsViewContainer;

	@FXML
	private ArraylistEfficiencyMainCanvas viewerCanvas;
