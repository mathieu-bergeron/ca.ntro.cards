...
public class FusionsortConstants {

	public static final double INITIAL_CARD_WIDTH_MILIMETERS = CommonConstants.INITIAL_CARD_WIDTH_MILIMETERS;
	public static final double INITIAL_CARD_HEIGHT_MILIMETERS = CommonConstants.INITIAL_CARD_HEIGHT_MILIMETERS;
