...
import ca.ntro.cards.fusionsort.frontend.views.controls.FusionsortEfficiencyMainCanvas;
...
public class FusionsortGraphsView extends EfficiencyGraphsView {

	@FXML
	private VBox cardsViewContainer;

	@FXML
	private FusionsortEfficiencyMainCanvas viewerCanvas;
